            ...
            <div class="col-xl-6 mx-auto">
                <div class="card shadow">
                    <div class="card-header">
                        <h1 class="h3">Проверка прав доступа к файлам</h1>
                        <p class="mb-0">Мы просканировали ваш сервер.<br>
                            Если у всего есть зеленая галочка, можно переходить к следующему шагу.</p>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li
                                class="list-group-item text-semibold d-flex align-items-center justify-content-between py-2 px-0">
                                <span><b>.env</b>Разрешение на доступ к файлам</span>
                            ...
                            <li
                                class="list-group-item text-semibold d-flex align-items-center justify-content-between py-2 px-0">
                                <span> <b>RouteServiceProvider.php</b> Разрешение на доступ к файлам</span>
                        ...
                        <p class="mt-3 d-flex">
                            ...
                            @if (
                                $permission['curl_enabled'] == 1 &&
                                    ...
                                    $phpVersion >= 7.4)
                                <a href="{{ route('installation.dbSetup') }}" class="btn btn-primary">Следующий <i
