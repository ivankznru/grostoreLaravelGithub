                ...
                <div class="card shadow">
                    <div class="card-body p-5 text-center">
                        <div class="mar-ver pad-btm">
                            <h2 class="h3">Запустите миграцию базы данных</h2>
                        </div>
                        <p>
                            Ваша база данных успешно подключена. Пожалуйста, запустите миграцию, чтобы настроить
                            базу данных.
                        </p>
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-4">
                            ...
                            <a href="{{ route('installation.runMigration') }}" class="btn btn-primary"
                                onclick="showLoder()">Запустите миграцию<i class="las la-arrow-right"></i></a>
