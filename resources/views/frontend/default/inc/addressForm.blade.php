         ...
         <div class="modal-content">
             <div class="modal-body">
                 ...
                 <div class="gstore-product-quick-view bg-white rounded-3 py-6 px-4">
                     <h2 class="modal-title fs-5 mb-3">Добавьте новый адресс</h2>
                     <div class="row align-items-center g-4 mt-3">
                         <form action="{{ route('address.store') }}" method="POST">
                             ...
                             <div class="row g-4">
                                 ...
                                 <div class="col-sm-6">
                                     <div class="w-100 label-input-field">
                                         ...
                                         <select class="select2Address" required name="state_id">
                                             <option value="">Выбрать штат</option>
                                 ...
                                 <div class="col-sm-6">
                                     <div class="w-100 label-input-field">
                                         ...
                                         <select class="select2Address" name="is_default">
                                             ...
                                             <option value="1">Установить по умолчанию</option>
                                         </select>
                                     </div>
                                 </div>
                                 ...
                                 <div class="col-sm-12">
                                     <div class="label-input-field">
                                         <label>Адресс</label>
                                         <textarea rows="4" placeholder="Казань" name="address"></textarea>
                                     </div>
                                 </div>
                             ...
                             <div class="mt-6 d-flex">
                                 <button type="submit"
                                     class="btn btn-secondary btn-md me-3">Сохранить</button>
                             </div>
                         </form>
                     </div>
                 </div>
     ...
     <div class="modal-dialog modal-dialog-centered">
         <div class="modal-content">
             <div class="modal-body">
                 <button type="button" class="btn-close float-end" data-bs-dismiss="modal" aria-label="Close"></button>
                 <div class="gstore-product-quick-view bg-white rounded-3 py-6 px-4">
                     <h2 class="modal-title fs-5 mb-3">Обновить адресс</h2>
         ...
         <div class="modal-content">
             <div class="modal-body">
                 ...
                 <div class="bg-white rounded-3 py-6 px-4">
                     <h2 class="modal-title fs-5 mb-3">Удалить адресс</h2>
                     <div class="pt-6 pb-8 text-center">
                         <h6>Хотите удалить этот адресс ?</h6>
                     </div>
                     <div class="text-center">
                         <a href="" class="btn btn-secondary delete-address-link">Удалить</a>
                     </div>
                 </div>
             </div>
         </div>
