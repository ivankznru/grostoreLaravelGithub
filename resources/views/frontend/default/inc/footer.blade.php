        ...
        <div class="row g-5">
            ...
            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                <div class="footer-widget">
                    ...
                    <ul class="footer-nav">
                        <li><a href="{{ route('customers.dashboard') }}">Твой счет</a></li>
                        <li><a href="{{ route('customers.orderHistory') }}">Твои заказы</a></li>
                        <li><a href="{{ route('customers.wishlist') }}">Ваш список желаний</a></li>
                        <li><a href="{{ route('customers.address') }}">Адресная книга</a></li>
                        <li><a href="{{ route('customers.profile') }}">Обновить профиль</a></li>
                    </ul>
                </div>
            </div>
