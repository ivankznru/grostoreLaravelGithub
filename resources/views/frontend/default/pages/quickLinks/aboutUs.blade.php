...
@section('title')
    О нас {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection

@section('breadcrumb-contents')
    <div class="breadcrumb-content">
        <h2 class="mb-2 text-center">О нас</h2>
        <nav>
            <ol class="breadcrumb justify-content-center">
                <li class="breadcrumb-item fw-bold" aria-current="page"><a
                        href="{{ route('home') }}">Домашная страница</a></li>
                <li class="breadcrumb-item fw-bold" aria-current="page">Страницы</li>
                <li class="breadcrumb-item fw-bold" aria-current="page">О</li>
            </ol>
        </nav>
    </div>
@endsection
    ...
    <section class="brands-section ptb-120 position-relative z-1 overflow-hidden service-section">
        ...
        <div class="container">
            <div class="brand-wrapper px-5 rounded-4">
                <h4 class="section-title mb-0">Самые популярные бренды</h4>
