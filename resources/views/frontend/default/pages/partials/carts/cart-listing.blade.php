@forelse ($carts as $cart)
    <tr>
        ...
        <td>
            <span class="text-dark fw-bold me-2 d-lg-none">Итоговая цена:</span>
            <span class="text-dark fw-bold">
                {{ formatPrice(variationDiscountedPrice($cart->product_variation->product, $cart->product_variation) * $cart->qty) }}
            </span>
        </td>
        <td>
            <span class="text-dark fw-bold me-2 d-lg-none">Удалить:</span>
...
@empty
    <tr>
        <td colspan="6" class="py-4">Данные не найдены</td>
    </tr>
@endforelse
