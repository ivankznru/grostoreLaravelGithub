<div class="sidebar-widget py-6 px-4 bg-white rounded-2">
    <div class="widget-title d-flex">
        <h5 class="mb-0 flex-shrink-0">Итог заказа</h5>
        <span class="hr-line w-100 position-relative d-block align-self-end ms-1"></span>
    </div>
    <table class="sidebar-table w-100 mt-5">
        <tr>
            <td>(+) Предметы ({{ count($carts) }}):</td>
    ...
    <div class="d-flex align-items-center justify-content-between">
        <h6 class="mb-0 fs-md">Общий</h6>
        <h6 class="mb-0 fs-md">{{ formatPrice($total) }}</h6>
    </div>

    <button type="submit" class="btn btn-primary btn-md rounded mt-6 w-100">Разместить заказ</button>
</div>
