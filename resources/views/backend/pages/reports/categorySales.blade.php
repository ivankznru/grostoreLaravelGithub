...
@section('title')
    Отчет о продажах категории {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Отчет о продажах по категориям</h2>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <select class="form-select select2" name="order"
                                                ...
                                                <option value="DESC"
                                                    @isset($order)
                                                        ...
                                                        @endisset>
                                                    Высокий ⟶ Низкий</option>

                                                <option value="ASC"
                                                    @isset($order)
                                                         @if ($order == 'ASC') selected @endif
                                                        @endisset>
                                                    Низкий ⟶ Высокий</option>
                                            </select>
                                        </div>
                                    </div>
                        ...
                        <table class="table tt-footable border-top" data-use-parent-width="true">
                            <thead>
                                <tr>
                                    ...
                                    <th>Имя категории</th>
                                    <th class="text-end">Полная распродажа</th>
                                </tr>
                            </thead>
                            <tbody>
