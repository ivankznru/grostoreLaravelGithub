...
@section('title')
    Отчет о сумме продаж {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Отчет о продажах с учетом суммы</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card mb-4" id="section-1">
                        ...
                        <table class="table tt-footable border-top" data-use-parent-width="true">
                            <thead>
                                <tr>
                                    ...
                                    <th>Дата</th>
                                    <th class="text-end">Тотальная распродажа</th>
                                </tr>
                            </thead>
                            <tbody>
                        ...
                        <div class="d-flex align-items-center justify-content-between px-4 pb-4">
                            <span>Показано
                                {{ $orderItems->firstItem() }}-{{ $orderItems->lastItem() }} о
                                {{ $orderItems->total() }} результаты</span>
                            <nav>
