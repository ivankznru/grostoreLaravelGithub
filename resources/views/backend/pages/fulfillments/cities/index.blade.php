...
@section('title')
    Города доставки {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                            ...
                            <div class="row justify-content-between align-items-center g-3">
                                <div class="col-auto flex-grow-1">
                                    <div class="tt-page-title">
                                        <h2 class="h5 mb-0">Города доставки</h2>
                                    </div>
                                </div>
                                <div class="col-auto">
                                ...
                                <div class="col-auto">
                                    @can('add_shipping_cities')
                                        <a href="{{ route('admin.cities.create') }}" class="btn btn-primary"><i
                                                data-feather="plus"></i>Добавить город</a>
                                    @endcan
                                </div>
                            </div>
                        </div>
