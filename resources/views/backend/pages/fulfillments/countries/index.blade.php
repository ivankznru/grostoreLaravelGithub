...
@section('title')
    Страны доставки {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                            ...
                            <div class="row justify-content-between align-items-center g-3">
                                <div class="col-auto flex-grow-1">
                                    <div class="tt-page-title">
                                        <h2 class="h5 mb-0">Страны доставки</h2>
                                    </div>
                                </div>
                                <div class="col-auto">
                    ...
                    @endisset>
                        ...
                        <table class="table tt-footable border-top" data-use-parent-width="true">
                            <thead>
                                <tr>
                                    ...
                                    <th>Имя</th>
                                    <th>Код</th>
                                    <th data-breakpoints="xs sm" class="text-end">Активный</th>
                        ...
                        <div class="d-flex align-items-center justify-content-between px-4 pb-4">
                            <span>Показать
                                ...
                                о
                                {{ $countries->total() }} Результаты</span>
                            <nav>
