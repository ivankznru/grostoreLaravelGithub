<div class="btn-group flex-wrap" role="group" aria-label="First group">
    @can('shipping_zones')
        <a href="{{ route('admin.logisticZones.index') }}"
            ...
            <i data-feather="disc" class="me-1"></i>Зоны
        </a>
    @endcan
    ...
    @can('shipping_cities')
        <a href="{{ route('admin.cities.index') }}"
            ...
            <i data-feather="pocket" class="me-1"></i>Города
        </a>
    @endcan
    ...
    @can('shipping_states')
        <a href="{{ route('admin.states.index') }}"
            ...
            <i data-feather="pie-chart" class="me-1"></i>Штаты
        </a>
    @endcan
    ...
    @can('shipping_countries')
        <a href="{{ route('admin.countries.index') }}"
            ...
            <i data-feather="globe" class="me-1"></i>Страны
        </a>
    @endcan
</div>
