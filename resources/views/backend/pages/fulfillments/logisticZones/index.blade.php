...
@section('title')
    Зоны доставки {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                            ...
                            <div class="row justify-content-between align-items-center g-3">
                                <div class="col-auto flex-grow-1">
                                    <div class="tt-page-title">
                                        <h2 class="h5 mb-0">Зоны доставки</h2>
                                    </div>
                                </div>
                                <div class="col-auto">
                                ...
                                @can('add_shipping_zones')
                                    <div class="col-auto">
                                        <a href="{{ route('admin.logisticZones.create') }}" class="btn btn-primary"><i
                                                data-feather="plus"></i>Добавте зону</a>
                                    </div>
                                @endcan
                            </div>
                        </div>
                    ...
                    <div class="card mb-4" id="section-1">
                        ...
                        <table class="table tt-footable border-top align-middle" data-use-parent-width="true">
                            <thead>
                                <tr>
                                    ...
                                    <th width="10%">Имя</th>
                                    <th width="15%">Логистика</th>
                                    <th data-breakpoints="xs sm">Города</th>
                                    <th data-breakpoints="xs sm" width="10%">Время доставки</th>
                                    <th data-breakpoints="xs sm" width="10%">Плата за доставку</th>
                                ...
                                @foreach ($logisticZones as $key => $logisticZone)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @empty
                                                <span class="badge bg-secondary rounded-pill">н/а</span>
                                            @endforelse
                                        </td>
                        ...
                        <div class="d-flex align-items-center justify-content-between px-4 pb-4">
                            <span>Показать
                                ...
                                о
                                {{ $logisticZones->total() }} результаты</span>
                            <nav>
