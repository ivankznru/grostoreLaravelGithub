...
@section('title')
    Логистика {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Логистика</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-4 g-4">
                        ...
                        <div class="col-12">
                            <div class="card mb-4" id="section-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between px-4 pb-4">
                                    <span>Показать
                                        {{ $logistics->firstItem() }}-{{ $logistics->lastItem() }} о
                                        {{ $logistics->total() }} результаты</span>
                                    <nav>
                        ...
                        @can('add_logistics')
                            <form action="{{ route('admin.logistics.store') }}" class="pb-650" method="POST">
                                ...
                                <div class="card mb-4" id="section-2">
                                    <div class="card-body">
                                        <h5 class="mb-4">Добавить новую логистику</h5>

                                        <div class="mb-4">
                                            <label for="name" class="form-label">Имя логистики</label>
                                            <input class="form-control" type="text" id="name" name="name"
                                                placeholder="Напишите имя логистики" required>
                                        </div>

                                        <div class="mb-4">
                                            <label class="form-label">Изображение логистики</label>
                                            <div class="tt-image-drop rounded">
                                                <span class="fw-semibold">Выберите значок логистики</span>
                                                <!-- choose media -->
                                    ...
                                    <div class="col-12">
                                        <div class="mb-4">
                                            <button class="btn btn-primary" type="submit">
                                                <i data-feather="save" class="me-1"></i>Сохранить логистику
                                            </button>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar">
                        <div class="card-body">
                            <h5 class="mb-4">Логистическая информация</h5>
                            <div class="tt-vertical-step">
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#section-1" class="active">Вся логистика</a>
                                    </li>

                                    @can('add_logistics')
                                        <li>
                                            <a href="#section-2">Добавить новую логистику</a>
                                        </li>
                                    @endcan
                                </ul>
                            </div>
