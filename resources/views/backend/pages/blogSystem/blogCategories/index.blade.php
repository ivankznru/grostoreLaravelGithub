...
@section('title')
    Категории блога {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Категории блога</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            <div class="card mb-4" id="section-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between px-4 pb-4">
                                    <span>Показать
                                        {{ $categories->firstItem() }}-{{ $categories->lastItem() }} Выкл
                                        {{ $categories->total() }} Результаты</span>
                                    <nav>
                        ...
                        @can('add_blog_categories')
                            <form action="{{ route('admin.blogCategories.store') }}" class="pb-650" method="POST">
                                ...
                                <div class="card mb-4" id="section-2">
                                    <div class="card-body">
                                        <h5 class="mb-4">Добавить новую категорию блога</h5>

                                        <div class="mb-4">
                                            <label for="name" class="form-label">Название категории</label>
                                            <input class="form-control" type="text" id="name" name="name"
                                                placeholder="Написать название категории" required>
                                        </div>
                                    </div>
                                </div>
                                <!-- Category info end-->
                        ...
                        <div class="card-body">
                            ...
                            <div class="tt-vertical-step">
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#section-1" class="active">Все категории</a>
                                    </li>
                                    @can('add_blog_categories')
                                        <li>
                                            <a href="#section-2">Добавить новую категорию</a>
                                        </li>
                                    @endcan
                                </ul>
                            </div>
