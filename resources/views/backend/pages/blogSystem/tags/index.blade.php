...
@section('title')
    Теги {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
            ...
            <div class="row mb-4 g-4">
                        ...
                        <div class="col-12">
                            <div class="card mb-4" id="section-1">
                                ...
                                <div class="d-flex align-items-center justify-content-between px-4 pb-4">
                                    <span>Показать
                                        {{ $tags->firstItem() }}-{{ $tags->lastItem() }} Выкл
                                        {{ $tags->total() }} Результаты</span>
                                    <nav>
                        ...
                        @can('add_tags')
                            <form action="{{ route('admin.tags.store') }}" class="pb-650" method="POST">
                                ...
                                <div class="card mb-4" id="section-2">
                                    <div class="card-body">
                                        <h5 class="mb-4">Добавте новый тег</h5>

                                        <div class="mb-4">
                                            <label for="name" class="form-label">Имя тега</label>
                                            <input class="form-control" type="text" id="name" name="name"
                                                placeholder="Написать имя тега" required>
                                        </div>
                                    </div>
                                </div>
                                <!-- tag info end-->
                                    ...
                                    <div class="col-12">
                                        <div class="mb-4">
                                            <button class="btn btn-primary" type="submit">
                                                <i data-feather="save" class="me-1"></i> Сохранить тег
                                            </button>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar">
                        <div class="card-body">
                            <h5 class="mb-4">Информация о теге</h5>
                            <div class="tt-vertical-step">
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#section-1" class="active">Все теги</a>
                                    </li>
                                    @can('add_tags')
                                        <li>
                                            <a href="#section-2">Добавте новый тег</a>
                                        </li>
                                    @endcan
                                </ul>
                            </div>
