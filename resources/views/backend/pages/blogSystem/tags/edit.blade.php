...
@section('title')
    Обновить тег {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Обновить тег</h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control" type="text" id="name" name="name"
                                        placeholder="Напишите имя тега" required value="{{ $tag->name }}">
                                </div>
                            </div>
                        </div>
