...
@section('title')
    Блоги {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Блоги</h2>
                            </div>
                            <div class="tt-action">
                                @can('add_blogs')
                                    <a href="{{ route('admin.blogs.create') }}" class="btn btn-primary"><i
                                            data-feather="plus"></i> Добавить блог</a>
                                @endcan
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="card mb-4" id="section-1">
                        ...
                        <table class="table tt-footable border-top" data-use-parent-width="true">
                            <thead>
                                <tr>
                                    ...
                                    <th>Заголовок</th>
                                    <th data-breakpoints="xs sm">Категория</th>
                                    <th data-breakpoints="xs sm md">Теги</th>
                        ...
                        <div class="d-flex align-items-center justify-content-between px-4 pb-4">
                            <span>Показать
                                {{ $blogs->firstItem() }}-{{ $blogs->lastItem() }} Выкл
                                {{ $blogs->total() }} Результат</span>
                            <nav>
    ...
    <script>
        ...
        function updateStatus(el) {
            ...
            $.post('{{ route('admin.blogs.updateStatus') }}', {
                ...
                function(data) {
                    if (data == 1) {
                        notifyMe('success', '{{ localize('Статус успешно обновлен') }}');
                    } else {
                        notifyMe('danger', '{{ localize('Что-то пошло не так') }}');
                    }
                });
        }
    </script>
