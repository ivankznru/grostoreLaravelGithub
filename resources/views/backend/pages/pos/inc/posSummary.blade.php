  ...
  <div class="tt-pos-calculation mb-3">
      <div class="tt-pos-cal">
          <p class="mb-0">Промежуточный итог</p>
          <strong>{{ formatPrice(getSubTotal($carts, false, '', false)) }}</strong>
      </div>
      <div class="tt-pos-cal">
          <p class="mb-0">Налог</p>
          <strong>{{ formatPrice(getTotalTax($carts)) }}</strong>
      </div>

      <div class="tt-pos-cal">
          <p class="mb-0">Плата за доставку</p>
          <input class="form-control col-6" type="number" placeholder="Введите сумму скидки"
      ...
      <div class="tt-pos-cal">
          <div class="row g-3">
              <div class="col-12">
                  <label for="discount_value" class="form-label">Дополнительная скидка</label>
                  <div class="input-group row g-0">
                      <input class="form-control col-6 rounded-end-0" type="number"
                          placeholder="Введите сумму скидки" id="additional_discount_value"
  ...
  <div class="tt-pos-payment mb-3">
      <div class="tt-single-pos-payment">
          ...
          <label for="cashPayment"
              class="tt-payment btn btn-sm btn-secondary fw-semibold d-block">Наличные</label>
      </div>
      <div class="tt-single-pos-payment">
          ...
          <label for="cardPayment" class="tt-payment btn btn-sm btn-secondary fw-semibold d-block"
              data-bs-toggle="modal" data-bs-target="#cardModal">Карта</label>
      </div>
      <div class="tt-single-pos-payment">
