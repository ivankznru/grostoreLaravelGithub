...
@section('title')
    Подписчики {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Подписчики</h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card mb-4" id="section-1">
                        ...
                        <div class="d-flex align-items-center justify-content-between px-4 pb-4">
                            <span>Показано
                                {{ $subscribers->firstItem() }}-{{ $subscribers->lastItem() }} о
                                {{ $subscribers->total() }} результаты</span>
                            <nav>
