...
@section('title')
    Отправка массовых электронных писем {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Отправка массовых электронных писем</h2>
                            </div>
                    ...
                    <form action="{{ route('admin.newsletters.send') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="card mb-4" id="section-1">
                            <div class="card-body">
                                ...
                                <div class="d-none">
                                    <label for="user_emails" class="form-label">Выбрать пользователей</label>
                                    <select class="form-select form-control select2"
                                        data-placeholder="Выбрать пользователей" data-toggle="select2"
                                ...
                                <div class="mb-4">
                                    <label for="subscriber_emails" class="form-label">Подписчики</label>
                                    <select class="form-select form-control select2"
                                        data-placeholder="Выберите подписчиков" data-toggle="select2"
                        ...
                        <div class="mb-4">
                            <button class="btn btn-primary" type="submit">
                                <i data-feather="save" class="me-1"></i> Отправить письма
                            </button>
                        </div>
                    </form>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="tt-vertical-step">
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#section-1" class="active">Отправить массовые электронные письма</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
