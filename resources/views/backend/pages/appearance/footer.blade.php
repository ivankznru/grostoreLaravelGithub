...
@section('title')
    Настройка нижнего колонтитула сайта {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Настройка нижнего колонтитула сайта</h2>
                            </div>
            ...
            <div class="row g-4">
                    ...
                    <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2" name="quick_links[]" class="w-100"
                                        data-toggle="select2" data-placeholder="Выберите страницы с быстрыми ссылками"
                                        multiple>
                                ...
                                <div class="mb-3">
                                    <label for="copyright_text" class="form-label">Авторский текст</label>
                        ...
                        <div class="card mb-4" id="section-2">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Логотип нижнего колонтитула</label>
                                    <input type="hidden" name="types[]" value="footer_logo">
                                    <div class="tt-image-drop rounded">
                                        <span class="fw-semibold">Выберите логотип нижнего колонтитула</span>
                                        <!-- choose media -->
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="tt-image-drop rounded">
                                        <span class="fw-semibold">Выберите баннер принятого платежа</span>
                                        <!-- choose media -->
                                        <div class="tt-product-thumb show-selected-files mt-3">
                                            <div class="avatar avatar-xl cursor-pointer choose-media"
                                                data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom"
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar d-none d-xl-block">
                        <div class="card-body">
                            <h5 class="mb-3">Настройка нижнего колонтитула</h5>
                            <div class="tt-vertical-step">
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#section-1" class="active">Общая информация</a>
                                    </li>
