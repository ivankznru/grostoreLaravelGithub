                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Вводный раздел</h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="about_intro_sub_title" id="about_intro_sub_title"
                                        placeholder="Ввести подзоголовок" class="form-control"
                                        value="{{ getSetting('about_intro_sub_title') }}">
                                </div>

                                <div class="mb-3">
                                    <label for="about_intro_title" class="form-label">Заголовок</label>
                                ...
                                <div class="mb-3">
                                    <label for="about_intro_text" class="form-label">Текст</label>
                                    <input type="hidden" name="types[]" value="about_intro_text">
                                    <input type="text" name="about_intro_text" id="about_intro_text"
                                        placeholder="Ввести текст" class="form-control"
                                        value="{{ getSetting('about_intro_text') }}">
                                </div>

                                <div class="mb-3">
                                    <label for="about_intro_mission" class="form-label">Миссия</label>
                                ...
                                <div class="mb-3">
                                    <label for="about_intro_vision" class="form-label">Зрение</label>
                                ...
                                <div class="mb-3">
                                    <label for="about_intro_quote" class="form-label">Цитировать</label>
                                    <input type="hidden" name="types[]" value="about_intro_quote">
                                    <textarea name="about_intro_quote" id="about_intro_quote" class="form-control">О вступительной цитате</textarea>
                                </div>

                                <div class="mb-3">
                                    <label for="about_intro_quote_by" class="form-label">Цитировать по</label>
