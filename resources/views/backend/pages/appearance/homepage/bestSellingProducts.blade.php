                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Самые продаваемые продукты</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    @endphp
                                    <label class="form-label">Самые продаваемые продукты</label>
                                    <input type="hidden" name="types[]" value="best_selling_products">
                                    <select class="select2 form-control" multiple="multiple"
                                        data-placeholder="Выберите продукты" name="best_selling_products[]"
                                        required>
