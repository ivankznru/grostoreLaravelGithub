                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Рекомендуемые продукты</h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="mb-4">
                                    <label for="featured_sub_title"
                                        class="form-label">Подзаголовок раздела</label>
                                ...
                                <div class="mb-4">
                                    ...
                                    @endphp
                                    <label class="form-label">Продукты в левой колонке</label>
                                    <input type="hidden" name="types[]" value="featured_products_left">
                                    <select class="select2 form-control" multiple="multiple"
                                        data-placeholder="Выберите продукты для левой колонки"
                                ...
                                <div class="mb-4">
                                    ...
                                    @endphp
                                    <label class="form-label">Продукты в правой колонке</label>
                                    <input type="hidden" name="types[]" value="featured_products_right">
                                    <select class="select2 form-control" multiple="multiple"
                                        data-placeholder="Выберите продукты для правой колонки"
                                ...
                                <div class="mb-4">
                                    <label class="form-label">Центральное изображение баннера</label>
                                ...
                                <div class="mb-4">
                                    <label for="featured_banner_link"
                                        class="form-label">Баннер ссылка</label>
