                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Что говорят клиенты</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                                ...
                                <table class="table tt-footable" data-use-parent-width="true">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Изображение</th>
                                            <th>Имя</th>
                                            <th data-breakpoints="xs sm md lg xl">Обзор</th>
                    ...
                    <form action="{{ route('admin.appearance.homepage.storeClientFeedback') }}" method="POST"
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <h5 class="mb-4">Добавить новый отзыв</h5>

                                <div class="mb-3">
                                    <label for="name" class="form-label">Имя</label>
                                    <input type="text" name="name" id="name"
                                        placeholder="Введите имя рецензента" class="form-control" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="review" class="form-label">Обзор</label>
                                    <textarea name="review" id="review" placeholder="Написать обзор" class="form-control" required></textarea>
                                </div>


                                <div class="mb-3">
                                    <label class="form-label">Изображение аватара</label>
                                    <div class="tt-image-drop rounded">
                                        <span class="fw-semibold">Выберите изображение аватара</span>
                                        <!-- choose media -->
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    <button class="btn btn-primary" type="submit">
                                        <i data-feather="save" class="me-1"></i> Сохранить отзыв
                                    </button>
                                </div>
                            </div>
                        </div>
