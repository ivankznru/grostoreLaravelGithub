                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Обновить отзыв</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-4 g-4">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" id="name"
                                        placeholder="Введите имя рецензента" class="form-control"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="review" id="review" placeholder="Написать обзор" class="form-control" required>{{ $singleFeedback->review }}</textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="tt-image-drop rounded">
                                        <span class="fw-semibold">Выбрать изображение для аватара</span>
                                        <!-- choose media -->
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar">
                        <div class="card-body">
                            <h5 class="mb-4">Настройка обратной связи с клиентами</h5>
                            <div class="tt-vertical-step">
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#section-1" class="active">Обновить отзыв</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
