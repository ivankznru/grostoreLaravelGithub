                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Популярные продукты</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    <label class="form-label">Самые популярные продукты</label>
                                    ...
                                    <select class="select2 form-control top_trending_products" multiple="multiple"
                                        data-placeholder="Выберите продукты" name="top_trending_products[]"
                                        required>
