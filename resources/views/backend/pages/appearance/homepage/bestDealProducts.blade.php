                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Еженедельные лучшие предложения</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input class="form-control date-picker" type="text"
                                            placeholder="Дата окончания" name="best_deal_end_date"
                                ...
                                <div class="mb-3">
                                    ...
                                    @endphp
                                    <label class="form-label">Лучшие предложения продуктов</label>
                                    <input type="hidden" name="types[]" value="weekly_best_deals">
                                    <select class="select2 form-control" multiple="multiple"
                                        data-placeholder="Выберите продукты" name="weekly_best_deals[]"
                                        required>
                                ...
                                <div class="mb-3">
                                    <label for="best_deal_banner_link"
                                        class="form-label">Баннерная ссылка</label>
