...
@section('title')
   Заказы{{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                        ...
                        <table class="table tt-footable border-top align-middle" data-use-parent-width="true">
                            <thead>
                                <tr>
                                    ...
                                    <th data-breakpoints="xs sm">Оплата</th>
                                    <th data-breakpoints="xs sm">Статус</th>
                                    <th data-breakpoints="xs sm">Тип</th>
                                    @if (count($locations) > 0)
                                        <th data-breakpoints="xs sm">Расположение</th>
                                    @endif
                                    <th data-breakpoints="xs sm" class="text-end">Действие</th>
                                </tr>
                            </thead>
                            <tbody>
