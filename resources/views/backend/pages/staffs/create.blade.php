...
@section('title')
    Добавить нового сотрудника {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Добавить нового сотрудника</h2>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control" type="text" id="phone"
                                        placeholder="Введите телефон сотрудника" name="phone">
                                </div>
