...
@section('title')
    Добавить новую страницу {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Добавить новую страницу</h2>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input class="form-control" type="text" id="title"
                                        placeholder="Напишите заголовок страницы" name="title" required>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="meta_title" id="meta_title"
                                        placeholder="Напишите метазаголовок" class="form-control">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="tt-image-drop rounded">
                                        <span class="fw-semibold">Выберите метаизображение</span>
                                        <!-- choose media -->
                            ...
                            <div class="col-12">
                                <div class="mb-4">
                                    <button class="btn btn-primary" type="submit">
                                        <i data-feather="save" class="me-1"></i>Сохранить страницу
                                    </button>
                                </div>
                            </div>
                        </div>
