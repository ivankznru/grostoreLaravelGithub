...
@section('title')
    Добавить новое местоположение {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Добавить местоположение</h2>
                            </div>
            ...
            <div class="row mb-4 g-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" id="name"
                                        placeholder="Введите имя местоположения" name="name" required>
                                </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="tt-image-drop rounded">
                                        <span class="fw-semibold">Выберите баннер местоположение</span>
                                        <!-- choose media -->
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar d-none d-xl-block">
                        <div class="card-body">
                            <h5 class="mb-3">Информация о местоположение</h5>
                            <div class="tt-vertical-step">
                                <ul class="list-unstyled">
                                    ...
                                    <li>
                                        <a href="#section-2">Изображение баннера</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
