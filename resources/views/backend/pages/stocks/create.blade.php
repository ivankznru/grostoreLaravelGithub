...
@section('title')
    Добавить склад {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Добавить склад</h2>
                            </div>
            ...
            <div class="row mb-4 g-4">
                    ...
                    <form action="{{ route('admin.stocks.store') }}" method="POST" class="pb-650">
                        ...
                        <div class="card mb-4" id="section-1">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="name" class="form-label">Месторасположение</label>
                                    <select class="select2 form-control" name="location_id" required>
                                        <option value="">Выбрать месторасположения</option>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    <button class="btn btn-primary" type="submit">
                                        <i data-feather="save" class="me-1"></i>Сохранить склад
                                    </button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar d-none d-xl-block">
                        <div class="card-body">
                            <h5 class="mb-3">Информация о складе</h5>
                            <div class="tt-vertical-step">
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#section-1" class="active">Информация о складе</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
