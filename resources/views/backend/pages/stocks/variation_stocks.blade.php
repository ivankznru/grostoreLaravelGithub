            ...
            <thead>
                <tr>
                    ...
                    <th data-breakpoints="xs sm">
                        <label for="" class="control-label">Склад</label>
                    </th>
                </tr>
            </thead>
...
@else
    <div class="mb-3">
        ...
        <div class="row g-3">
            ...
            <div class="col-lg-12">
                <div class="mb-3">
                    <label for="stock" class="form-label">Склад</label>
                    <input type="number" id="stock" placeholder="Количество на складе" name="stock"
