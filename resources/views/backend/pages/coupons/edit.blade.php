...
@section('title')
    Обнавить купон {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Обнавить купон</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-4 g-4">
                ...
                <div class="col-xl-9 order-2 order-md-2 order-lg-2 order-xl-1">
                    <form action="{{ route('admin.coupons.update') }}" method="POST" class="pb-650">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="number"
                                                    placeholder="Напишите сумму скидки"
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="tt-image-drop rounded">
                                        <span class="fw-semibold">Выберите баннер купон</span>
                                        <!-- choose media -->
                        ...
                        <div class="card mb-4" id="section-2">
                            <div class="card-body">
                                <h5 class="">Продукты и категории</h5>
                                ...
                                <div class="mb-4">
                                    ...
                                    @endphp
                                    <label for="parent_id" class="form-label">Продукты</label>
                                    <select class="form-control select2" class="w-100" data-toggle="select2"
                                        data-placeholder="Выберите продукты" name="product_ids[]"
                                        multiple>
                        ...
                        <div class="card mb-4" id="section-3">
                            <div class="card-body">
                                <h5 class="mb-4">Конфигурация купона</h5>
                                <div class="mb-4">
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar d-none d-xl-block">
                        <div class="card-body">
                            <h5 class="mb-4">Информация о купоне</h5>
                            <div class="tt-vertical-step">
                                <ul class="list-unstyled">
                                    ...
                                    <li>
                                        <a href="#section-2">Продукты и категории</a>
                                    </li>
                                    <li>
