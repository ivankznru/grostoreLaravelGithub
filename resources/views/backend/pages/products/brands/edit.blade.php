...
@section('title')
    Обновить бренд {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                            ...
                            <div class="row g-3 align-items-center">
                                <div class="col-auto flex-grow-1">
                                    <div class="tt-page-title">
                                        <h2 class="h5 mb-0">Обновить бренд <sup
                        ...
                        <div class="card mb-4" id="section-1">
                            <div class="card-body">
                                ...
                                @if (env('DEFAULT_LANGUAGE') == $lang_key)
                                    <div class="mb-4">
                                        <label for="slug" class="form-label">Слаг бренда</label>
                                        <input type="text" name="slug" id="slug"
                                            placeholder="Введите слаг бренда" class="form-control" required
                                            value="{{ $brand->slug }}">
                                    </div>
                                @endif
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="tt-image-drop rounded">
                                        <span class="fw-semibold">Выберите иконку бренда</span>
                                        <!-- choose media -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea class="form-control" name="meta_description" id="meta_description" rows="4"
                                        placeholder="Введите ваше мета-описание">{{ $brand->collectLocalization('meta_description', $lang_key) }}</textarea>
                                </div>
                                <div class="mb-4">
