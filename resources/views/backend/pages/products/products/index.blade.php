                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Продукты</h2>
                            </div>
                            <div class="tt-action">
                                @can('add_products')
                                    <a href="{{ route('admin.products.create') }}" class="btn btn-primary"><i
                                            data-feather="plus"></i> Добавте продукт</a>
                                @endcan
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="card mb-4" id="section-1">
                        ...
                        <table class="table tt-footable border-top" data-use-parent-width="true">
                            <thead>
                                <tr>
                                    ...
                                    <th>Имя продукта</th>
                                    <th data-breakpoints="xs sm">Бренды</th>
                                    <th data-breakpoints="xs sm">Категории</th>
                                    <th data-breakpoints="xs sm">Цена</th>
                                    <th data-breakpoints="xs sm md">Опубликован</th>
                                ...
                                @foreach ($products as $key => $product)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @empty
                                                <span class="badge rounded-pill bg-secondary">Н/А</span>
                                            @endforelse
                                        </td>
                                        <td>
                                            ...
                                            <div class="dropdown tt-tb-dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end shadow">
                                                    ...
                                                    <a class="dropdown-item"
                                                        ...
                                                        target="_blank">
                                                        <i data-feather="eye"
                                                            class="me-2"></i>Посмотреть детали
                                                    </a>
                                                </div>
                                            </div>
                                        </td>
                        ...
                        <div class="d-flex align-items-center justify-content-between px-4 pb-4">
                            <span>Показано
                                {{ $products->firstItem() }}-{{ $products->lastItem() }} о
                                {{ $products->total() }} результаты</span>
                            <nav>
