...
@section('title')
    Категории {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Категории</h2>
                            </div>
                            <div class="tt-action">
                                @can('add_categories')
                                    <a href="{{ route('admin.categories.create') }}" class="btn btn-primary"><i
                                            data-feather="plus"></i> Добавить категорию</a>
                                @endcan
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="card mb-4" id="section-1">
                        ...
                        <table class="table tt-footable border-top" data-use-parent-width="true">
                            <thead>
                                <tr>
                                    ...
                                    <th>Имя категории</th>
                                    <th data-breakpoints="xs sm">Основная категория</th>
                                    <th data-breakpoints="xs sm">Бренды</th>
                                    <th data-breakpoints="xs sm">Приоритет</th>
                        ...
                        <div class="d-flex align-items-center justify-content-between px-4 pb-4">
                            <span>Показано
                                {{ $categories->firstItem() }}-{{ $categories->lastItem() }} о
