...
@section('title')
    Обновить вариацию {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                            ...
                            <div class="row g-3 align-items-center">
                                <div class="col-auto flex-grow-1">
                                    <div class="tt-page-title">
                                        <h2 class="h5 mb-0">Обновить вариацию<sup
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="name"
                                        ...
                                        placeholder="Имя вариации" class="form-control" required>
                                </div>
                            </div>
                        </div>
