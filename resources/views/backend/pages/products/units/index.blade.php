...
@section('title')
    Единицы {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                    ...
                    <div class="card tt-page-header">
                        <div class="card-body d-lg-flex align-items-center justify-content-lg-between">
                            <div class="tt-page-title">
                                <h2 class="h5 mb-lg-0">Единицы</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-4 g-4">
                        ...
                        <div class="col-12">
                            <div class="card mb-4" id="section-1">
                                ...
                                <table class="table tt-footable border-top" data-use-parent-width="true">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Имя</th>
                                            <th data-breakpoints="xs sm">Активен</th>
                                ...
                                <div class="d-flex align-items-center justify-content-between px-4 pb-4">
                                    <span>Показано
                                        {{ $units->firstItem() }}-{{ $units->lastItem() }} о
                                        {{ $units->total() }} результаты</span>
                                    <nav>
                    ...
                    @can('add_units')
                        <form action="{{ route('admin.units.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="card mb-4" id="section-2">
                                <div class="card-body">
                                    <h5 class="mb-4">Добавить новую единицу</h5>

                                    <div class="mb-4">
                                        <label for="name" class="form-label">Имя единицы</label>
                                        <input type="text" name="name" id="name"
                                            placeholder="Введите имя единицы" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <!--brand info end-->
                ...
                <div class="col-xl-3 order-1 order-md-1 order-lg-1 order-xl-2">
                    <div class="card tt-sticky-sidebar">
                        <div class="card-body">
                            <h5 class="mb-4">Информация о единице</h5>
                            <div class="tt-vertical-step">
                                <ul class="list-unstyled">
                                    <li>
                                        <a href="#section-1" class="active">Все единицы</a>
                                    </li>
                                    @can('add_units')
                                        <li>
                                            <a href="#section-2">Добавить новую единицу</a>
                                        </li>
                                    @endcan
                                </ul>
                            </div>
