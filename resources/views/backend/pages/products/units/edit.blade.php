...
@section('title')
    Обновить единицу {{ getSetting('title_separator') }} {{ getSetting('system_title') }}
@endsection
                            ...
                            <div class="row g-3 align-items-center">
                                <div class="col-auto flex-grow-1">
                                    <div class="tt-page-title">
                                        <h2 class="h5 mb-0">Обновить единицу<sup
                        ...
                        <div class="card mb-4" id="section-1">
                            <div class="card-body">
                                ...
                                @if (env('DEFAULT_LANGUAGE') == $lang_key)
                                    <div class="mb-4">
                                        <label for="slug" class="form-label">Слаг единицы</label>
                                        <input type="text" name="slug" id="slug"
                                            placeholder="Введите слаг единицы" class="form-control" required
                                            value="{{ $unit->slug }}">
                                    </div>
                                @endif
                            </div>
