    ...
    <div class="d-table table-layout-fixed w-100">
        <a class="d-table-cell mobile-toolbar-item  mobile-menu-toggle">
            <span class="mobile-toolbar-icon"><i class="fas fa-bars"></i></span><span
                class="mobile-toolbar-label">Категория
            </span>
        </a>
        <div class="gshop-header-search dropdown d-table-cell mobile-toolbar-item">
            <button class="header-icon" type="button" data-bs-toggle="dropdown">
                ...
                <span class="mobile-toolbar-label">Поиск</span>
            </button>
            <div class="dropdown-menu dropdown-menu-start border-0">
                <form class="search-form d-flex align-items-center" action="<?php echo e(route('products.index')); ?>">
                    <input type="text" placeholder="Искать продукты..." class="w-100"
        ...
        <a class="d-table-cell mobile-toolbar-item" href="<?php echo e(route('customers.dashboard')); ?>">
            ...
            <span class="mobile-toolbar-label">Счет</span>
        </a>
...
<?php /**PATH F:\LARAVEL PROJECT\c-grostore-food-grocery-laravel update 9  1\resources\views/frontend/default/inc/bottomToolbar.blade.php ENDPATH**/ ?>