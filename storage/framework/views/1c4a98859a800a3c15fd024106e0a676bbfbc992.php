            ...
            <div class="row align-items-center">
                ...
                <div class="col-xxl-8 col-xl-9">
                    ...
                    <ul
                        ...
                        <li class="nav-item">
                            <a href="mailto:<?php echo e(getSetting('topbar_email')); ?>">
                                <span class="me-1">
                        ...
                        <li class="nav-item dropdown tt-language-dropdown">
                            ...
                            <?php if(\App\Models\Location::count() > 1): ?>
                                ...
                                <a href="#" class="dropdown-toggle text-capitalize " data-bs-toggle="dropdown"
                                    aria-haspopup="true" aria-expanded="false"><?php echo e($location->name); ?></a>
                                    ...
                                    <?php $__currentLoopData = \App\Models\Location::where('is_published', 1)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                                            <a class="dropdown-item fs-xs text-capitalize" href="javascript:void(0);"
                                                onclick="changeLocation(this)" data-location="<?php echo e($location->id); ?>">
                        ...
                        <li class="nav-item dropdown tt-curency-dropdown">
                            <a href="#" class="dropdown-toggle text-uppercase" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"><?php echo e($currentCurrency->symbol); ?>
                        ...
                        <li class="nav-item">
                            <a href="javascript:void(0)" class="btn btn-link p-0 tt-theme-toggle fw-normal">
                                <div class="tt-theme-light" data-bs-toggle="tooltip" data-bs-placement="left"
                                    data-bs-title="Темная">Темная тема <i class="fas fa-moon fs-lg ms-1"></i>
                                </div>
                                <div class="tt-theme-dark" data-bs-toggle="tooltip" data-bs-placement="left"
                                    data-bs-title="Светлая">Светлая тема <i class="fas fa-sun fs-lg ms-1"></i>
                                </div>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="row align-items-center">
                <div class="col-xxl-2 col-xl-3 col-md-3 col-5">
                    <a href="<?php echo e(route('home')); ?>" class="logo"><img
                            src="<?php echo e(uploadedAsset(getSetting('navbar_logo'))); ?>" alt="logo" class="img-fluid"></a>
                </div>
                    ...
                    <div class="gshop-navbar-right d-flex align-items-center justify-content-end position-relative">
                        <div class="category-dropdown position-relative d-none d-md-inline-block">
                            ...
                            <a href="javascript:void(0)"
                                class="category-dropdown-btn fw-bold d-none d-sm-inline-block">Категории<span
                        ...
                        <nav class="gshop-navmenu ms-3 d-none d-xl-block">
                            <ul class="d-flex align-itmes-center justify-content-end">
                                <li><a href="<?php echo e(route('home')); ?>">Домой</a></li>
                                <li><a href="<?php echo e(route('products.index')); ?>">Продукты</a></li>
                                <li><a href="<?php echo e(route('home.campaigns')); ?>">Кампании</a>
                                </li>
                                <li><a href="<?php echo e(route('home.coupons')); ?>">Купоны</a>
                                </li>

                                <li class="has-submenu">
                                    <a href="javascript:void(0);">Страницы<span
                                    ...
                                    <ul>
                                        ...
                                        <li><a
                                                href="<?php echo e(route('home.pages.aboutUs')); ?>">О нас</a>
                                        </li>
                                        <li><a
                                                href="<?php echo e(route('home.pages.contactUs')); ?>">Связаться с нами</a>
                                        </li>
                                    ...
                                    <ul class="user-menu">
                                        <?php if(auth()->guard()->check()): ?>
                                            <?php if(auth()->user()->user_type == 'customer'): ?>
                                                <li><a href="<?php echo e(route('customers.dashboard')); ?>"><span class="me-2"><i
                                                                class="fa-solid fa-user"></i></span>Мой счет</a>
                                                </li>
                                                <li><a href="<?php echo e(route('customers.orderHistory')); ?>"><span
                                                            class="me-2"><i
                                                                class="fa-solid fa-tags"></i></span>Мои заказы</a>
                                                </li>
                                                <li><a href="<?php echo e(route('customers.wishlist')); ?>"><span class="me-2"><i
                                                                class="fa-solid fa-heart"></i></span>Мой список пожеланий</a>
                                                </li>
                                            <?php else: ?>
                                                <li><a href="<?php echo e(route('admin.dashboard')); ?>"><span class="me-2"><i
                                                                class="fa-solid fa-bars"></i></span>Админка</a>
                                                </li>
                                            <?php endif; ?>

                                            <li><a href="<?php echo e(route('logout')); ?>"><span class="me-2"><i
                                                            class="fa-solid fa-arrow-right-from-bracket"></i></span>Выйти
                                                </a></li>
                                        <?php endif; ?>
                                        ...
                                        <?php if(auth()->guard()->guest()): ?>
                                            <li><a href="<?php echo e(route('login')); ?>"><span class="me-2"><i
                                                            class="fa-solid fa-arrow-right-from-bracket"></i></span>Войти</a>
                                            </li>
                                        <?php endif; ?>
                        ...
                        <div
                            ...
                            <a href="tel:<?php echo e(getSetting('navbar_contact_number')); ?>"
                                ...
                                <div class="ms-3">
                                    <span class="text-muted fs-xs">Телефон</span>
...
<?php /**PATH F:\LARAVEL PROJECT\c-grostore-food-grocery-laravel update 9  1\resources\views/frontend/default/inc/header.blade.php ENDPATH**/ ?>