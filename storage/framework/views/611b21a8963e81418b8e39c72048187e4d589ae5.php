<div class="vertical-product-card rounded-2 position-relative swiper-slide <?php echo e(isset($bgClass) ? $bgClass : ''); ?>">
    ...
    <div class="card-content">
        ...
        <?php if(isset($showSold)): ?>
            ...
            <p class="mb-0 fw-semibold">Всего продано: <span
            ...
            <form action="" class="direct-add-to-cart-form">
                ...
                <?php if(!$isVariantProduct && $stock < 1): ?>
                    <a href="javascript:void(0);"
                        class="btn btn-outline-secondary btn-md border-secondary d-block mt-4 w-100">Распродано</a>
                <?php else: ?>
                    <a href="javascript:void(0);"
                        onclick="directAddToCartFormSubmit(this)"class="btn btn-outline-secondary btn-md border-secondary d-block mt-4 w-100 direct-add-to-cart-btn add-to-cart-text">Добавить в корзину</a>
                <?php endif; ?>
            </form>
        <?php endif; ?>
...
<?php /**PATH F:\LARAVEL PROJECT\c-grostore-food-grocery-laravel update 9  1\resources\views/frontend/default/pages/partials/products/vertical-product-card.blade.php ENDPATH**/ ?>